...
public class GroupController {
  ...
  public final static String POST_ADD_USER = "/group/{groupName}/add-user/{userId}";
  @PostMapping(POST_ADD_USER)
  public ViewContext addUser(@PathVariable String groupName, @PathVariable UUID userId){
